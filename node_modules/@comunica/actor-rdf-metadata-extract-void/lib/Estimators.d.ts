 ...
 */
export declare function estimatePatternCardinality(dataset: IVoidDataset, pattern: Algebra.Pattern): RDF.QueryResultCardinality;
/**
 ...
 */
export declare function estimatePatternCardinalityRaw(dataset: IVoidDataset, pattern: Algebra.Pattern): number;
/**
