...
function parseIgnorePatterns(config) {
    if (!(config === null || config === void 0 ? void 0 : config.ignorePatterns)) {
        return;
    }
...
exports.rule = {
    ...
    create(context) {
        ...
        const ignorePatterns = (_a = parseIgnorePatterns(context.options[0])) !== null && _a !== void 0 ? _a : defaultConfiguration.ignorePatterns.reduce(mapPatternReducer, []);
        ...
        for (const set of commentSets) {
            ...
            try {
                const parse = (_b = parser.parse) !== null && _b !== void 0 ? _b : parser.parseForESLint;
                if (!parse) {
                    throw new Error(`unexpected error: no 'parse' method found`);
                }
                parse(lines.join('\n'), Object.assign(Object.assign({}, context.parserOptions), { 
                    ...
                    loc: true, range: true, raw: true, tokens: true, comment: true, eslintVisitorKeys: true, eslintScopeManager: true, filePath: context.getFilename(), 
                    ...
                    project: undefined, projects: undefined }));
                for (const comment of set) {
